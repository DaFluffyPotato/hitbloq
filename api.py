...
def extend_scores(leaderboard_data, score_data, base_rank, user_data=None):
    ...
    for i, score in enumerate(score_data):
        ...
        score['accuracy'] = round(score['score'] / max(1, leaderboard_data['max_score']) * 100, 2)

function postAddUser(status, json_response) {
  if (json_response['status'] == 'success') {
    document.getElementById('user-addition-notification').innerHTML = '<p>Added to the <a href="/actions" class="highlight link">Action Queue</a>! After the ScoreSaber data has been downloaded, you can search for your ScoreSaber username.</p>';
  } else {
